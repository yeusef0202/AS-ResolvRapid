...
const CarPage = (props) => {
  return (
    <div className="car-page-container">
      <Helmet>
        <title>CarPage - Downright Average Eel</title>
        <meta property="og:title" content="CarPage - Downright Average Eel" />
      </Helmet>
      <div className="car-page-android-large8">
        <img
          alt="Rectangle23091741"
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/b6204680-0e1d-4392-9385-b5e891cd295a/232b00e3-97a6-4b80-882e-8c84fb480a95?org_if_sml=13534"
          className="car-page-rectangle2309"
        />
        <img
        ...
        <img
          ...
          src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/b6204680-0e1d-4392-9385-b5e891cd295a/2affdd7f-e8ad-4dd2-b5a8-600a4641a29d?org_if_sml=1680"
          className="car-page-icons8car482"
        />
        <img
